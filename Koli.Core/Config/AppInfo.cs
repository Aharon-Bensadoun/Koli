...
public static class AppInfo
{
    ...
    public static void Initialize(Assembly hostAssembly) => _hostAssembly = hostAssembly;

    private static Assembly Assembly => _hostAssembly ?? Assembly.GetExecutingAssembly();
